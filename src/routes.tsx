...
const AIRules = lazy(() =>
  import('./pages/AIRules').then((m) => ({ default: m.AIRules }))
)
...
const CmsTeam = lazy(() =>
  import('./pages/cms/Team').then((m) => ({ default: m.CmsTeam }))
)
...
const CmsHero = lazy(() =>
  import('./pages/cms/Hero').then((m) => ({ default: m.CmsHero }))
)
const CmsPage = lazy(() =>
  import('./pages/cms/Page').then((m) => ({ default: m.CmsPage }))
)
...
export function AppRouter() {
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/sign-in" element={<LazyPage><SignIn /></LazyPage>} />
